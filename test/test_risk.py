...
class TestRisk(unittest.TestCase):
    ...
    def test_get_attacker_condition_field_values_mapping_1(self):
        ...
        a = get_attacker_condition_field_values_mapping(mapping_type, map_to_range_sep, attacker_condition_field_values, field_values_in_d)
    ...
    def test_set_attacker_condition_fields_values_map_f_1(self):
        a_c_f
        set_attacker_condition_fields_values_map_f(a_c_f_v_m_i, a_c_f_m, a_i, ds)
